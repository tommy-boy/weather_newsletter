...
#$Languages[0]['FileName'] = "/apps/dev/www.azcentral.com/htdocs/generated/weather_today.inc";
#$Languages[0]['FilenameTemp'] = "/apps/dev/www.azcentral.com/htdocs/generated/ForecastToday.inc.tmp";
$Languages[0]['FileName'] = "/apps/generated/weather/generated/weather_today.inc";
$Languages[0]['FilenameTemp'] = "/apps/generated/weather/generated/ForecastToday.inc.tmp";
$Languages[0]['Template'] = "/apps/projects/weather/bin/redesign_weathertoday.template";
...
for($i=0;$i<$LanguageCount;$i++){
  $tmpTemplate = join("",file($Languages[$i]['Template']));
	...
	#$curTemp=ltrim(strip_tags(file_get_contents("/apps/dev/www.azcentral.com/htdocs/generated/phxtemperature.inc")),'|');
