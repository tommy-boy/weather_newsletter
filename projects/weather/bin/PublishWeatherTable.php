...
$Languages[0]['Filename'] = "/www_live/azc/htdocs/weather/incs/weather_forecast.inc";
$Languages[0]['FilenameTemp'] = "/www_live/azc/htdocs/weather/incs/ForecastTable.inc.tmp";
$Languages[0]['Tablename'] = "narrative";
$Languages[0]['Template'] = "/data/projects/weather/bin/forecast_table.template.new";
$Languages[1] = Array();
...
$Languages[1]['Template'] = "/data/projects/weather/bin/forecast_table.spanish.template";
...
# Adding the 3 day version
$Languages[4] = Array();
$Languages[4]['Name'] = "English";
$Languages[4]['ImagePath'] = "/weather/images2/"; 
$Languages[4]['Header'] = "Metro Phoenix forecast";
$Languages[4]['Filename'] = "/www_live/azc/htdocs/weather/incs/12_3day_current.inc";
$Languages[4]['FilenameTemp'] = "/www_live/azc/htdocs/weather/incs/12_3day_current.inc.tmp";
$Languages[4]['Tablename'] = "narrative";
$Languages[4]['Template'] = "/data/projects/weather/bin/12_3day_current.template";
# Adding the 12 news next day.
$Languages[5] = Array();
$Languages[5]['Name'] = "English";
$Languages[5]['ImagePath'] = "/weather/images2/"; 
$Languages[5]['Header'] = "Metro Phoenix forecast";
$Languages[5]['Filename'] = "/www_live/azc/htdocs/weather/incs/12_3day_next.inc";
$Languages[5]['FilenameTemp'] = "/www_live/azc/htdocs/weather/incs/12_3day_next.inc.tmp";
$Languages[5]['Tablename'] = "narrative";
$Languages[5]['Template'] = "/data/projects/weather/bin/12_3day_next.template";
