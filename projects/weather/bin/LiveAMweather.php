...
//$languages[0]['FileName']="/apps/staging/www.azcentral.com/htdocs/generated/homepage_weathertab.inc";
//$languages[0]['FileNameTemp']="/apps/staging/www.azcentral.com/htdocs/generated/HomepageWeatherTab.inc.tmp";
...
for($i=0;$i<$languagecount;$i++){
  ...
  while($r=mysql_fetch_object($res)){
    ...
    if($count==0){
       $tmpTemplate=str_replace($dayofweek_to_replace,"Today",$tmpTemplate);
    } elseif ($count==1) {
